...
export default function FollowersScreen() {
  ...
  const {
    ...
    hasNextPage,
    isFetchingNextPage,
  } = useUserFollowers(username || user?.username || '', debouncedSearch || undefined);
  ...
  // Always show total followers count from user profile, not from search results
  const totalCount = user?.followersCount ?? 0;
